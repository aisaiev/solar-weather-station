...
//   HELTEC_SERIAL_TX (GPIO17) → Heltec GPIO4 (Serial Module RXD in Meshtastic config)
//   HELTEC_SERIAL_RX (GPIO18) ← Heltec GPIO5 (Serial Module TXD in Meshtastic config)
//   GND ──────────────────── GND
//
...
private:
    ...
    static size_t writeLenDelim(uint8_t* buf, uint8_t field,
