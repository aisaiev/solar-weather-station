...
export const selectVariants = cva('relative inline-block w-full rounded-md group');

export const selectTriggerVariants = cva(
  mergeClasses(
    'flex w-full items-center justify-between gap-2 rounded-md border border-input bg-transparent',
    'transition-colors outline-none cursor-pointer disabled:cursor-not-allowed',
