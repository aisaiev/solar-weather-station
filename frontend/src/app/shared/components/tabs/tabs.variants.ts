...
export const tabNavVariants = cva('flex gap-4', {
  variants: {
    zPosition: {
      top: 'flex-row flex-wrap border-b mb-4',
      bottom: 'flex-row flex-wrap border-t mt-4',
      left: 'flex-col overflow-auto border-r mr-4 min-h-0',
      right: 'flex-col overflow-auto border-l ml-4 min-h-0',
    },
    zAlignTabs: {
      start: 'justify-start',
