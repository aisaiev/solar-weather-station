...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    label?: string | number
    labelFormatter?: (label: string | number | undefined, payload: RechartsPrimitive.TooltipPayload) => React.ReactNode
    labelClassName?: string
    formatter?: (value: RechartsPrimitive.TooltipValueType | undefined, name: string | undefined, item: RechartsPrimitive.TooltipPayloadEntry, index: number, payload: RechartsPrimitive.TooltipPayload) => React.ReactNode
    color?: string
    hideLabel?: boolean
              ...
              return (
                ...
                >
                  {formatter && item?.value !== undefined && item.name ? (
                    formatter(item.value, String(item.name), item, index, item.payload as RechartsPrimitive.TooltipPayload)
                  ) : (
                    <>
                      {itemConfig?.icon ? (
                        <itemConfig.icon />
